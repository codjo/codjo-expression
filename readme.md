...
Une nouvelle méthode plus complète pour l'aide sur les fonctions est mis en place cf net.codjo.expression.help.
L'ancien moyen symbolisé par FunctionHolder.getAllFunctions est maintenant deprecated. 
Exemple d'utilisation avec le comportement par défaut:
    ...
    System.out.println("tooltip = " + help.getHelp()); // "Usage : my.lastDay(chaîne)"
    ```
